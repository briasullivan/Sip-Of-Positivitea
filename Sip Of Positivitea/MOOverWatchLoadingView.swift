...
public class MOOverWatchLoadingView: UIView {
    ...
    public convenience init(frame: CGRect, autoStartAnimation: Bool, color: UIColor) {
    ...
    private func createLayers() {
        ...
        hexagonShapes = (0 ..< 7).map { _ in
            ...
            hexagonShape.fillColor = color.cgColor
            hexagonShape.masksToBounds = true
            hexagonShape.path = hexagonPath.cgPath
            hexagonShape.strokeColor = color.cgColor
            return hexagonShape
        }
        ...
        outerCircleShape.strokeColor = color.cgColor
        ...
        curveShapes = [arcPath1, arcPath2, arcPath3].map { path in
            ...
            curveShape.strokeColor = color.cgColor
        ...
        innerCircleShape.strokeColor = color.cgColor
